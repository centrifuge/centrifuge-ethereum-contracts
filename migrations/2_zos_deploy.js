...
async function deploy(options) {
    ...
    const identityFactory = await create(Object.assign({ contractAlias: 'IdentityFactory', initMethod: 'initialize' }, options));
    const anchorRepository = await create(Object.assign({ contractAlias: 'AnchorRepository', initMethod: 'initialize'}, options));
